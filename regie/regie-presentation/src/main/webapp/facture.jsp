			...
			<ul class="custom-scrollbar">
				...
				<li>
					 <ul class="collapsible collapsible-accordion">
                        <li>
                        <a class="collapsible-header waves-effect arrow-r " href="saisieaffaire"><i class="fa fa-chevron-right"></i> Affaire</a>
                            
                        </li>
                        <li>
                        <a class="collapsible-header waves-effect arrow-r active" href="facture"><i class="fa fa-hand-pointer-o"></i> Facture</a>
                           
                        </li>
                        <li>
                        <a class="collapsible-header waves-effect arrow-r "href="recouvrement"><i class="fa fa-envelope-o"></i> Recouvernement</a>
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-4 md-form">
							<input type="text" id="form-text" class="form-control"></input> <label
						...
						<div class="col-md-4 md-form">
							<input type="text" id="form-Subject" class="form-control" disabled>
							<label for="form-Subject">Numero Bultin</label>
						</div>
					</div>
				...
				<div class="card-body">
					...
					<div class="row">
						<!-- Body -->
						<div class="col-md-6 md-form">
							<i class="fa fa-sort-amount-asc prefix grey-text"></i> <input type="text"
								id="form-name" class="form-control" disabled> <label
								for="form-name">Taux de Majoration</label>
						</div>

						<div class="col-md-6 md-form">
							<i class="fa  fa-address-book-o prefix grey-text"></i> <input
								type="text" id="form-name" class="form-control" disabled> <label
								for="form-name"> Montant Majore </label>
						</div>
						
						<div class="col-md-6 md-form">
							<i class="fa fa-sort-amount-desc prefix grey-text"></i> <input type="text"
								id="form-name" class="form-control" disabled> <label
								for="form-name">Taux de Remise</label>
						</div>
						...
						<div class="col-md-4 md-form">
							<i class="fa  fa-money prefix grey-text"></i> <input
								type="text" id="form-name" class="form-control" disabled> <label
